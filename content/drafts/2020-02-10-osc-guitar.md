...
category: audio
author: jackson
description: "A gesture-driven guitar built in Puredata, utilizing sensor data from a mobile device"
---
...
{{ figure(src="/img/oscguitar-g-main.png", caption="Frontpage of Pd patch") }}
...
{{ figure(src="/img/oscguitar-g-waveguide.png", caption="Waveguide model of a string") }}
...
{{ figure(src="/img/oscguitar-g-model.png", caption="The guitar model sub-patch") }}
...
{{ figure(src="/img/oscguitar-rnd-strings.png", caption="Sub-patch for the randomizer") }}
...
{{ figure(src="https://sensors2.org/wp-content/uploads/2015/02/osc.png", caption="Sensor2OSC") }}
...
{{ figure(src="/img/oscguitar-g-osc.png", caption="Receiving and manipulating OSC data from the phone") }}
