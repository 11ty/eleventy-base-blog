...
{% include "figure.njk"
    src: "/img/soniweb-2-pd.png"
    caption: "A little restructured and a much better reverb implementation"
%}
...
{% include "figure.njk"
    src: "/img/soniweb-2-boop.png"
    caption: "The new patch for one of the voices"
%}
